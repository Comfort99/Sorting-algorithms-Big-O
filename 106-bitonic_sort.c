#include "sort.h"
/**
 * swap - Swap two ingeters in an array
 * @a: The first ingeter to swap
...
/**
 * bitonic_merge - Sort a bitonic sequence inside
 ...
 * Description: Implements the Bitonic sort algorithm.
